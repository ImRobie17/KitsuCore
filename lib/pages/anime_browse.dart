    ...
    return Scaffold(
              ...
              DrawerHeader(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Anime Hub', style: TextStyle(color: theme.colorScheme.primary, fontSize: 18, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 4),
                    Text('Discover & save favorites', style: TextStyle(color: Colors.white70)),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          const BottomNavigationBarItem(icon: Icon(Icons.playlist_play), label: 'My List'),
          const BottomNavigationBarItem(icon: Icon(Icons.add_box), label: 'Add'),
          const BottomNavigationBarItem(icon: Icon(Icons.menu_book), label: 'Manga'),
      ...
      case 0: // Home
        return Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Anime', style: TextStyle(color: theme.colorScheme.primary, fontSize: 20, fontWeight: FontWeight.bold)),
              const SizedBox(height: 12),
              Expanded(
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              const Text('Add new anime to your collection', style: TextStyle(color: Colors.white70)),
            ],
          ),
        );
      ...
      case 4: // Profile
        return Center(
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const CircleAvatar(radius: 36, backgroundColor: Colors.white24, child: Icon(Icons.person, size: 36)),
              const SizedBox(height: 12),
              const Text('User Profile', style: TextStyle(color: Colors.white70)),
              const SizedBox(height: 8),
              Text(
                'My List: ${myListManager.totalItems} items',
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text('Browse anime and manga to add them to your list!', style: TextStyle(color: Colors.white54, fontSize: 12)),
          ],
        ),
      );
    }
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text('No anime in your list', style: TextStyle(color: Colors.white70)),
          ],
        ),
      );
    }
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text('No manga in your list', style: TextStyle(color: Colors.white70)),
          ],
        ),
      );
    }
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      TextButton.icon(
                        ...
                        icon: Icon(isAdded ? Icons.check : Icons.playlist_add, color: theme.colorScheme.primary),
                        label: Text(isAdded ? 'Added' : 'Add to my list', style: const TextStyle(color: Colors.white70)),
