          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildInfoCard(
                          Icons.camera_alt_outlined, "Genre", "Psychological"),
                      const SizedBox(height: 10),
                      _buildInfoCard(Icons.access_time, "Duration", "29h 36m"),
                      const SizedBox(height: 10),
                      _buildInfoCard(
                          Icons.thumb_up_outlined, "Upvotes", "5.6k"),
                      const SizedBox(height: 10),
              ...
              children: List.generate(5, (index) {
                return IconButton(
                  ...
                  icon: Icon(
                    ...
                    color: index < selectedStars ? starColor : Colors.grey[500],
                    size: 30,
                  ),
                );
              })
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(color: themeColor, width: 1), // Orange Border
              ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      const Color(0xFF8D5B35), // Brownish/Orange gradient look
